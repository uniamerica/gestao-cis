...
public class PatientsController {
  ...
  @PostMapping
  public final ResponseEntity<PatientResponseDTO> save(
      @RequestBody NewPatientRequestDTO responseBody) throws Exception {
    try {
  ...
  public final ResponseEntity<List<PatientResponseDTO>> findListOfPatientsByFullName(
  ...
  public final ResponseEntity<PatientResponseDTO> updatePatient(
      @RequestParam UUID uuid, @RequestBody NewPatientRequestDTO responseBody) {
    try {
  ...
  //    @PutMapping("/{id}")
  //    public ResponseEntity<?> update(@lPathVariable Long id, @RequestBody User patient) throws
  // Exception {
  //        try{
