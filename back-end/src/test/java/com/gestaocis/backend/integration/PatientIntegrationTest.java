...
public class PatientIntegrationTest {
    ...
    public void save_returnsSavedPatientDto_whenSuccessful(){
        ...
        NewPatientRequestDTO patientToBeCreatedDTO = NewPatientRequestDTO.builder()
                .cpf("99999999991")
                .rg("88888888881")
        ...
        ResponseEntity<PatientResponseDTO> response = testRestTemplate
                .postForEntity("/api/pacientes", patientToBeCreatedDTO, PatientResponseDTO.class);

        Assertions.assertThat(response).isNotNull();

        Assertions.assertThat(response.getStatusCode().value()).isEqualTo(201);
        Assertions.assertThat(Objects.requireNonNull(response.getBody()).getEmail()).isEqualTo(patientToBeCreatedDTO.getEmail());
    }
    ...
    public void findByName_returnsListOfPatientDTO_whenSuccessful(){
        ...
        ResponseEntity<PatientResponseDTO[]> response = testRestTemplate.getForEntity("/api/pacientes/name/" + name,PatientResponseDTO[].class);
    ...
    public void findAll_returnListOfPatientDTO_WhenSuccessful() {
        ResponseEntity<PatientResponseDTO[]> response = testRestTemplate.getForEntity("/api/pacientes",PatientResponseDTO[].class);
    ...
    public void findByCpf_returnsPatientDTO_whenSuccessful(){
        ...
        ResponseEntity<PatientResponseDTO> response = testRestTemplate.getForEntity("/api/pacientes/cpf/" + cpf, PatientResponseDTO.class);
    ...
    public void updatePatient_returnUpdatedPatientDTO_whenSuccessful(){
        ...
        NewPatientRequestDTO patientToBeUpdated = NewPatientRequestDTO.builder()
                ...
                .build();
        ResponseEntity<NewPatientRequestDTO> response = testRestTemplate.exchange("/api/pacientes/{uuid}", HttpMethod.PUT, new HttpEntity<>(patientToBeUpdated), NewPatientRequestDTO.class, uuid);
    ...
    public void deletePatient_returnUpdatedPatientDTO_whenSuccessful(){
        ...
        ResponseEntity<String> response = testRestTemplate.exchange("/api/pacientes/{uuid}", HttpMethod.DELETE, null, String.class, uuid);
