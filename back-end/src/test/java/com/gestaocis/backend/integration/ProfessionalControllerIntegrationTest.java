...
public class ProfessionalControllerIntegrationTest {
    ...
    @Test
    public void shouldSaveProfessional() {
        NewProfessionalRequestDTO professional = ProfessionalCreator.createValidProfessionalRequestDtoToBeSaved();
        ResponseEntity<ProfessionalResponseDTO> responseEntity = this.restTemplate
                .postForEntity("http://localhost:"+ port +"/api/pacientes", professional, ProfessionalResponseDTO.class);
