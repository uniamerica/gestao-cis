...
public class SecretaryIntegrationTest {
    ...
    public void findByUuid_returnsSecretaryDTO_whenSuccessful(){
        ResponseEntity<SecretaryResponseDTO> response = testRestTemplate.exchange("/api/admin/secretaries/id/{uuid}", HttpMethod.GET, null,  SecretaryResponseDTO.class, uuid );
    ...
    public void updateSecretary_returnUpdatedSecretaryDTO_whenSuccessful(){
        ...
        NewSecretaryRequestDTO secretaryToBeUpdated = NewSecretaryRequestDTO.builder()
                .email("test2@test.com")
                .phone("(45)9995595959")
                .fullName("João Teste da Silva")
                .cep("85858150")
                ...
                .build();
        ResponseEntity<NewSecretaryRequestDTO> response = testRestTemplate.exchange("/api/admin/secretaries/{uuid}", HttpMethod.PUT, new HttpEntity<>(secretaryToBeUpdated), NewSecretaryRequestDTO.class, uuid);
    ...
    public void deleteSecretary_returnUpdatedSecretaryDTO_whenSuccessful(){
        ...
        ResponseEntity<String> response = testRestTemplate.exchange("/api/admin/secretaries/{uuid}", HttpMethod.DELETE, null, String.class, uuid);
