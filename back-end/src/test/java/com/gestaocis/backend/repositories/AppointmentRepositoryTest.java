...
class AppointmentRepositoryTest {
    ...
    private User createUserPatient(){
        RoleEntity roleEntity = roleEntityRepository
                .save(RoleEntity.builder().roleName(Role.ROLE_PATIENT).build());
    ...
    private User createUserCreator(){
        ...
        RoleEntity roleEntity = roleEntityRepository
                .save(RoleEntity.builder().roleName(Role.ROLE_SECRETARY).build());
    ...
    void find_listOfAppointmentsByProfessional_whenSuccessful(){
        ...
        Assertions.assertThat(appointmentList)
                .isNotNull()
                .isNotEmpty()
                .contains(appointmentSaved);
    }
    ...
    void find_listOfAppointmentsByScheduledForBetween_whenSuccessful(){
        ...
        List<Appointment> appointmentList = appointmentRepository.findByScheduledForBetween(date1,date2);
